...
```bash
npx -y firecrawl-cli@1.7.0 init --all --browser
```
...
```bash
npm install -g firecrawl-cli@1.7.0
```
...
2. Try: `npx firecrawl-cli@1.7.0 --version`
3. Reinstall: `npm install -g firecrawl-cli@1.7.0`
