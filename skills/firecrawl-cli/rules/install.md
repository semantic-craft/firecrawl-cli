...
```bash
npx -y firecrawl-cli@1.9.2 init --all --browser
```
...
```bash
npm install -g firecrawl-cli@1.9.2
```
...
2. Try: `npx firecrawl-cli@1.9.2 --version`
3. Reinstall: `npm install -g firecrawl-cli@1.9.2`
