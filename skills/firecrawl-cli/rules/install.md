...
```bash
npx -y firecrawl-cli@1.19.4 init -y --browser
```
...
```bash
npm install -g firecrawl-cli@1.19.4
```
...
2. Try: `npx firecrawl-cli@1.19.4 --version`
3. Reinstall: `npm install -g firecrawl-cli@1.19.4`
